...
import { computed, mergeProps, unref, withCtx, createVNode, createTextVNode, useSSRContext } from 'file:///Users/apple/Sites/Saloo/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderList } from 'file:///Users/apple/Sites/Saloo/node_modules/vue/server-renderer/index.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "pt-16" }, _attrs))}><div class="section-padding"><div class="container-max">`);
      if (unref(journey)) {
        ...
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<iconify-icon icon="lucide:arrow-left" class="mr-2"${_scopeId}></iconify-icon> Back to Journeys `);
            } else {
              return [
                ...
                createTextVNode(" Back to Journeys ")
              ];
            }
          }),
          _: 1
        }, _parent));
        _push(`<div class="mb-12"><h1 class="text-4xl md:text-5xl font-bold mb-4">${ssrInterpolate(unref(journey).title)}</h1><p class="text-xl text-gray-600 mb-6">${ssrInterpolate(unref(journey).description)}</p><div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8"><div class="bg-gray-50 p-4 rounded-lg"><h3 class="font-semibold text-gray-900 mb-2">Duration</h3><p class="text-blue-600">${ssrInterpolate(unref(journey).duration)}</p></div><div class="bg-gray-50 p-4 rounded-lg"><h3 class="font-semibold text-gray-900 mb-2">Distance</h3><p class="text-blue-600">${ssrInterpolate(unref(journey).distance)}</p></div><div class="bg-gray-50 p-4 rounded-lg"><h3 class="font-semibold text-gray-900 mb-2">Continents</h3><p class="text-blue-600">${ssrInterpolate(unref(journey).continents.length)}</p></div></div></div><div class="mb-12">`);
        _push(ssrRenderComponent(_component_NuxtImg, {
          src: unref(journey).image,
          alt: unref(journey).title,
          class: "w-full h-96 object-cover rounded-lg"
        }, null, _parent));
        _push(`</div><div class="mb-12"><h2 class="text-2xl font-bold mb-6">Journey Highlights</h2><div class="grid grid-cols-1 md:grid-cols-2 gap-4"><!--[-->`);
        ssrRenderList(unref(journey).highlights, (highlight) => {
          _push(`<div class="flex items-center p-4 bg-blue-50 rounded-lg"><iconify-icon icon="lucide:check-circle" class="text-blue-600 mr-3"></iconify-icon><span>${ssrInterpolate(highlight)}</span></div>`);
        });
        _push(`<!--]--></div></div><div class="mb-12"><h2 class="text-2xl font-bold mb-6">Continents Covered</h2><div class="flex flex-wrap gap-3"><!--[-->`);
        ssrRenderList(unref(journey).continents, (continent) => {
          _push(`<span class="px-4 py-2 bg-blue-100 text-blue-800 rounded-full">${ssrInterpolate(continent)}</span>`);
        });
        _push(`<!--]--></div></div></div>`);
      } else {
        _push(`<div class="text-center py-16"><h1 class="text-3xl font-bold mb-4">Journey Not Found</h1><p class="text-gray-600 mb-8">The journey you&#39;re looking for doesn&#39;t exist.</p>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: "/journeys",
          class: "btn-primary"
        }, {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/journeys/[id].vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=_id_-B7Lhj5zV.mjs.map
